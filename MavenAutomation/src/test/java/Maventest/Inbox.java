...
//			     Product
		...
		Thread.sleep(1000);
		List<WebElement> Productelement = driver
				.findElements(By.xpath("//li[contains(@class, 'rz-multiselect-item ')]"));
...
//				 Refresh.click();
		...
		if (datavalue.contains(ApplicantName)) {
			...
			driver.findElement(By.xpath("//span[@class='btn btn-secondary rounded-pill']")).click();

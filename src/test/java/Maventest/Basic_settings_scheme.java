...
public class Basic_settings_scheme {
...
//	          scheme name
		Thread.sleep(1000);
		WebElement schname = driver.findElement(By.xpath("//input[@title='Name']"));
		Actions clear = new Actions(driver);

		clear.moveToElement(schname).doubleClick().sendKeys(Keys.BACK_SPACE).doubleClick().sendKeys(Keys.BACK_SPACE)
				.perform();

		XSSFSheet addscheme = wb.getSheetAt(4);

		XSSFRow addschemerow = addscheme.getRow(2);
...
//		     short name
		Thread.sleep(1000);
		WebElement shotname = driver.findElement(By.xpath("//input[@title='Short Name']"));
		Actions clear1 = new Actions(driver);

		clear1.moveToElement(shotname).doubleClick().sendKeys(Keys.BACK_SPACE).perform();
...
//		     Tenure mode
		...
		Thread.sleep(1000);
		List<WebElement> tenuredrop = driver.findElements(By.xpath(".//*[@_bl_56='']/li"));
...
//		      max tenure
		Thread.sleep(1000);
		WebElement mtenure = driver.findElement(By.xpath("//input[@placeholder='Max Tenure']"));
		Actions clear2 = new Actions(driver);

		clear2.moveToElement(mtenure).doubleClick().sendKeys(Keys.BACK_SPACE).perform();
...
//		      Max Apply Amount
		Thread.sleep(1000);
		WebElement maamount = driver.findElement(By.xpath("//input[@placeholder='Max Apply Amt']"));

		Actions clear3 = new Actions(driver);

		clear3.moveToElement(maamount).doubleClick().sendKeys(Keys.BACK_SPACE).doubleClick().sendKeys(Keys.BACK_SPACE)
				.doubleClick().sendKeys(Keys.BACK_SPACE).perform();
...
//		      Minimum ROI
		...
		WebElement minroi = driver.findElement(By.xpath("//input[@placeholder='Minimum ROI']"));

		Actions clear4 = new Actions(driver);

		clear4.moveToElement(minroi).doubleClick().sendKeys(Keys.BACK_SPACE).doubleClick().sendKeys(Keys.BACK_SPACE)
				.doubleClick().sendKeys(Keys.BACK_SPACE).perform();
...
//		     Maximum ROI
		Thread.sleep(1000);
		WebElement maxroi = driver.findElement(By.xpath("//input[@placeholder='Maximum ROI']"));

		Actions clear5 = new Actions(driver);

		clear5.moveToElement(maxroi).doubleClick().sendKeys(Keys.BACK_SPACE).doubleClick().sendKeys(Keys.BACK_SPACE)
				.doubleClick().sendKeys(Keys.BACK_SPACE).perform();
...
//		     defualt roi
		Thread.sleep(1000);
		WebElement defroi = driver.findElement(By.xpath("//input[@placeholder='Default ROI']"));

		Actions clear6 = new Actions(driver);

		clear6.moveToElement(defroi).doubleClick().sendKeys(Keys.BACK_SPACE).doubleClick().sendKeys(Keys.BACK_SPACE)
				.doubleClick().sendKeys(Keys.BACK_SPACE).perform();
...
//		       Default Interest Type
		...
		Thread.sleep(1000);
		List<WebElement> intresttypedrop = driver.findElements(By.xpath(".//*[@_bl_68='']/li"));
...
//		     Default Installment Type
		...
		Thread.sleep(1000);
		List<WebElement> intallmentdrop = driver.findElements(By.xpath(".//*[@_bl_70='']/li"));
...
//		       Default Installment Mode
		...
		Thread.sleep(1000);
		List<WebElement> intallmentmodedrop = driver.findElements(By.xpath(".//*[@_bl_72='']/li"));
...
//		       OD Interest
		Thread.sleep(1000);
		WebElement odint = driver.findElement(By.xpath("//input[@placeholder='OD Interest']"));

		Actions clear7 = new Actions(driver);

		clear7.moveToElement(odint).doubleClick().sendKeys(Keys.BACK_SPACE).doubleClick().sendKeys(Keys.BACK_SPACE)
				.doubleClick().sendKeys(Keys.BACK_SPACE).perform();
...
//		     FOIR Percentage
		Thread.sleep(1000);
		WebElement foirper = driver.findElement(By.xpath("//input[@placeholder='FOIR Percentage']"));

		Actions clear8 = new Actions(driver);

		clear8.moveToElement(foirper).doubleClick().sendKeys(Keys.BACK_SPACE).doubleClick().sendKeys(Keys.BACK_SPACE)
				.doubleClick().sendKeys(Keys.BACK_SPACE).perform();
...
//	//	    clear button
//		       Thread.sleep(2000);
//		       WebElement clearbutton = driver.findElement(By.xpath("//button[@class='btn btn-light ']"));
//		       clearbutton.click();
